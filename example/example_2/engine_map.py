...
for i in range(len(FF)):
    ...
    EINO.append(k_nox[0] + k_nox[1]*PR + k_nox[2]*PR**2 + k_nox[3]*ff + k_nox[4]*ff**2 + k_nox[5]*ff*PR)
    EICO.append(k_co[0] + k_co[1]*PR + k_co[2]*PR**2 + k_co[3]*ff + k_co[4]*ff**2 + k_co[5]*ff*PR)
